...
package org.apache.skywalking.apm.plugin.jedis.commons;
...
public enum RedisMethodMatch {
    ...
    public List<WitnessMethod> get4XWitnessMethodMatcher() {
        return Collections.singletonList(new WitnessMethod(
                "redis.clients.jedis.Pipeline",
                named("persist").and(takesArguments(0))));
    }

    public List<String> get3XWitnessClasses() {
        return Arrays.asList("redis.clients.jedis.Client");
    }
}
