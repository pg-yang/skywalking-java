...
public class ExchangeImplInterceptor implements InstanceMethodsAroundInterceptor {
    ...
    public void beforeMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, MethodInterceptResult result) throws Throwable {
        ...
        MicronautCommons.startTrace(request, requestURI);
    }
    ...
    public Object afterMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, Object ret) throws Throwable {
        ...
        return MicronautCommons.buildTracePublisher(request, retPublisher);
    }

    @Override
    public void handleMethodException(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, Throwable t) {
        MicronautCommons.finishOnAction((MutableHttpRequest<?>) allArguments[0], span -> span.errorOccurred().log(t));
    }
