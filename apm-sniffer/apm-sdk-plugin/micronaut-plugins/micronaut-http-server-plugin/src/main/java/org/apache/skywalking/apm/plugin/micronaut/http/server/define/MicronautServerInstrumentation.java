...
public class MicronautServerInstrumentation extends ClassInstanceMethodsEnhancePluginDefine {
    ...
    private static final String SERVER_RESPONSE_INTERCEPT_CLASS = "org.apache.skywalking.apm.plugin.micronaut.http.server.ServerWriteAndFlushNettyInterceptor";
    ...
    public InstanceMethodsInterceptPoint[] getInstanceMethodsInterceptPoints() {
        return new InstanceMethodsInterceptPoint[]{
                ...
                new InstanceMethodsInterceptPoint() {
                    @Override
                    public ElementMatcher<MethodDescription> getMethodsMatcher() {
                        return named("syncWriteAndFlushNettyResponse").and(takesArguments(4));
                    }

                    @Override
                    public String getMethodsInterceptor() {
                        return SERVER_RESPONSE_INTERCEPT_CLASS;
                    }
