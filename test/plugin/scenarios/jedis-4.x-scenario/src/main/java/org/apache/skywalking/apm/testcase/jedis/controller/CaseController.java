...
//
//        try (ClusterCommandExecutor clusterCommandExecutor = new ClusterCommandExecutor(redisHost, redisPort)) {
//            clusterCommandExecutor.set("a", "a");
//            clusterCommandExecutor.get("a");
//            clusterCommandExecutor.del("a");
//        }
